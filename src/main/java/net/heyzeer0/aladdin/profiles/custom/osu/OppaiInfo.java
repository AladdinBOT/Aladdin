...
public class OppaiInfo {
    ...
    public OppaiInfo(String oppai_version, int code, String errstr, String artist, String title, String creator, String version, String mods_str, int mods, double od, double ar, double cs, double hp, int combo, int max_combo, int num_circles, int num_sliders, int num_spinners, int misses, int score_version, long stars, long speed_stars, long aim_stars, int nsingles, int nsingles_threshold, long aim_pp, long speed_pp, long acc_pp, long pp) {
        this.oppai_version = oppai_version; this.code = code; this.errstr = errstr; this.artist = artist; this.title = title;
