        ...
        if(args.get(0).equalsIgnoreCase("recommend") || args.get(0).equalsIgnoreCase("rec")) {
            ...
            Utils.runAsync(() -> {
                try{
                    ...
                    b.setDescription("[Normal](https://osu.ppy.sh/d/" + bp.getBeatmapset_id() + ") - [No Vid](https://osu.ppy.sh/d/" + bp.getBeatmapset_id() + "n) - [Bloodcat](https://bloodcat.com/osu/s/" + bp.getBeatmapset_id() + ") - [Direct](osu://dl/" + bp.getBeatmapset_id() + ")");
