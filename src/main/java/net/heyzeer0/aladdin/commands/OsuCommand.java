        ...
        if(args.get(0).equalsIgnoreCase("recommend") || args.get(0).equalsIgnoreCase("rec")) {
            ...
            Utils.runAsync(() -> {
                try{
                    ...
                    g2d.drawString("Stars: " + Math.round(map100.getStars()) + " - " + map100.getMax_combo() + "x | AR: " + Math.round(map100.getAr()) + " OD: " + Math.round(map100.getOd()) + " HP: " + Math.round(map100.getHp()) + " CS: " + Math.round(map100.getCs()) + " BPM: " + Math.round(Integer.valueOf(bp.getBpm())) + " " + (map100.getMods_str().equals("") ? "" : "+" + map100.getMods_str()), 122, 236);
